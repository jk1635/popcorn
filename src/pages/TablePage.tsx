...
import { calculateMonth, calculateTotal, convertDate, formatNumber, prepareMonthlyData } from '@utils/';
                    ...
                    <Table>
                        <Thead>
                            ...
                            <Tr>
                                ...
                                <RightAlignTh>
                                    {formatNumber(
                                        calculateTotal(monthlyData, 'Revenue') -
                                            calculateTotal(monthlyData, 'Commission')
                                    )}
                                </RightAlignTh>
                            ...
                            {monthlyData.map((monthly, monthlyIndex) => (
                                <>
                                    <Tr key={monthly.AppKey}>
                                        ...
                                        <RightAlignTd>
                                            {formatNumber(monthly.Revenue - monthly.Commission)}
                                        </RightAlignTd>
                                        <CenterAlignTd>
                                            ...
                                            <>
                                                <CampaignBg key={app.AppName}>
                                                    <Td style={{ paddingLeft: '2rem' }}>
                                                        <DropdownButton
                                                            onClick={() => toggleAppRow(monthlyIndex, appIndex)}
                                                        >
                                                    ...
                                                    <RightAlignTd>
                                                        {formatNumber(app.Revenue - app.Commission)}
                                                    </RightAlignTd>
                                                    <Td></Td>
                                                </CampaignBg>
                                                {rowState[monthlyIndex]?.apps?.[appIndex] && (
                                                    <>
                                                        ...
                                                        {app.Campaign.map(campaign => (
                                                            <Tr key={campaign.CampaignKey}>
                                                                ...
                                                                <RightAlignTd>
                                                                    {formatNumber(campaign.Complete)}
                                                                </RightAlignTd>
                                                                <RightAlignTd>
                                                                    {formatNumber(campaign.Revenue)}
                                                                </RightAlignTd>
                                                                <RightAlignTd>
                                                                    {formatNumber(campaign.Commission)}
                                                                </RightAlignTd>
                                                                <RightAlignTd>
                                                                    {formatNumber(
                                                                        campaign.Revenue - campaign.Commission
                                                                    )}
                                                                </RightAlignTd>
                                                                <Td></Td>
                                                            </Tr>
